...
interface HeroProps {
  ...
  actions?: Array<{
    label: string;
    href: string;
    variant?: "default" | "destructive" | "outline" | "secondary" | "ghost" | "link" | null | undefined; // Explicitly list common button variants
  }>;
  titleClassName?: string;
  subtitleClassName?: string;
  actionsClassName?: string;
  // Add other specific HTML attributes if needed, e.g., id?: string;
}
  ...
  (
    ...
    return (
      <section
        ref={ref}
        className={cn(
          "relative z-0 flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background",
          className,
        )}
        {...props}
      >
